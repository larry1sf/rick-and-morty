            ...
            <header className="flex items-start justify-between relative z-10">
                <div className="flex items-center gap-4">
                    <div className="relative">
                        <div
                            className="absolute inset-0 bg-primary/20 rounded-2xl blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        <div
                            ...
                            <IcoPlaneta className="size-6 text-primary" />
                        </div>
                    </div>
                    <div className="flex flex-col gap-0.5">
                        ...
                        >
                            Ref. #{(id ?? "1").toString().padStart(3, "0")}
                        </span>
                    </div>
                </div>
                ...
                <a
                    href={`/ubicacion/${id}`}
                    title={`Ir a los detalles de la ubicación ${name}`}
            ...
            <footer
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        >{residents?.length || 0} Residentes</span>
                    </div>
                </div>
                <Button
                    isLink={{
                        href: `/ubicacion/${id}`,
                        title: `Ir a los de talles de la ubicación ${name}`
                    }}
