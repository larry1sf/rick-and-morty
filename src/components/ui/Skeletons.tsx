export function SkeletonCardPersonaje() {
    return (
        <div className="flex flex-col h-auto md:h-[590px] bg-slate-900/40 backdrop-blur-md rounded-3xl border border-white/10 overflow-hidden animate-pulse">
...
export function SkeletonCardUbicacion() {
    return (
        <div className="flex flex-col h-auto md:h-[350px] p-6 gap-5 bg-slate-900/40 backdrop-blur-md rounded-3xl border border-white/10 overflow-hidden animate-pulse">
